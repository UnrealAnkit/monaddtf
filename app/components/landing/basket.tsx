    ...
    <section id="basket" className="mt-28 scroll-mt-28">
      <Reveal>
        ...
        <div className="mt-12 grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            <h3 className="font-heading text-3xl font-bold tracking-tight">MONAD ECOSYSTEM BASKET</h3>
            <p className="mt-4 max-w-md text-sm leading-relaxed text-gray-600">
              A weighted index of the Monad ecosystem: DeFi tokens, a liquid-staking derivative and a
              stablecoin, held against target weights and priced by an on-chain oracle router. Hover an
