      ...
      <Reveal>
        <div className="relative max-w-7xl ml-auto mr-auto overflow-hidden rounded-3xl border border-[#1f4fb4]/25 bg-linear-to-br from-[#1f4fb4]/10 via-[#f3e6c5]/60 to-transparent px-8 py-16 text-center sm:px-16">
          ...
          <p className="relative mx-auto mt-4 max-w-md text-sm leading-relaxed text-gray-600">
            Free testnet tokens from the built-in faucet. Connect a wallet and mint your first DEMO in
            under a minute.
          </p>
          <div className="relative mt-9">
            <LaunchAppButton className="rounded-full bg-black px-10 text-white shadow-lg transition-shadow hover:bg-black/85 hover:shadow-[0_0_28px_rgba(217,91,33,0.35)]">
              MINT YOUR FIRST DEMO →
            </LaunchAppButton>
          </div>
        </div>
      </Reveal>
