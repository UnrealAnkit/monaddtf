// "Why Alloy" — four protocol-guarantee cards with inline icons.
...
const FEATURES = [
  {
    ...
    body: "One mMON in, three assets out. Swaps route through the configured DEX router atomically inside the mint transaction.",
    icon: (
  ...
  },
  {
    ...
    body: "Prices come from a Chainlink-compatible oracle router (Pyth, Chainlink, Chronicle, Supra and Switchboard all publish Monad feeds) with a staleness guard built in.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="h-6 w-6">
  ...
  },
  {
    ...
    body: "NAV, balances and supply are read straight from Monad contracts — plain Solidity, no indexer, no backend.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="h-6 w-6">
...
export function Features() {
  return (
    <section id="why" className="mt-28 scroll-mt-28">
      <Reveal>
        <SectionLabel>WHY ALLOY</SectionLabel>
      </Reveal>
