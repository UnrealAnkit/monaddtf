...
// Decorative geometric motif. Reads as a small vault "bloom": a four-petal
// flower (the DEMO share token) ringed by three orbiting dots (the three
// basket assets). Purely decorative.
...
// Three orbiting assets, evenly spaced around the bloom.
const ORBIT = Array.from({ length: 3 }, (_, i) => {
...
export function FolioMotif() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <svg viewBox="0 0 260 260" className="h-56 w-56 drop-shadow-[0_18px_40px_rgba(19,35,71,0.18)]">
        {/* soft halo */}
